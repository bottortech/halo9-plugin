...
private:
    ...
    struct CircleButtonLAF : juce::LookAndFeel_V4
    {
                                  ...
                                  bool isMouseOverButton, bool isButtonDown) override
        {
            ...
            // Slightly thicker ring stroke for a more premium feel
            ...
            // Very subtle soft glow on hover (cheap, no blur)
                            ...
                            bool, bool) override
        {
            ...
            float f = (float)b.getHeight() * 0.30f; // slightly stronger weight
            g.setFont(juce::Font(f, juce::Font::bold));

            // Better vertical centering and crisper rendering
    ...
    // ── Logo image (drawn centered below Top Hub; no visible strip) ──────
    ...
    void placeOnArc(juce::Component& comp, float angleRad,
                    int w, int h, float radius);

    // ── Top Hub layout rect (painted in paint, knobs positioned over it) ─────
